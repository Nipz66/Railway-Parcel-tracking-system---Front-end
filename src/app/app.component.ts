...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, StaffNavbarComponent, ParcelReportComponent, StaffRegistationComponent, NavBarComponent, AddParcelComponent, AdminNavbarComponent, StaffManagementComponent, AdminLoginComponent],
